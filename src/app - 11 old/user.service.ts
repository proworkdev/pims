...
export class UserService {
  ...
  addTicket(title,assigned_user,action,status,description,sku,type) {
    var payload = new FormData();    
  ...
  addOrder(user_id,ticket_stage,svg_image,jpg_image,special_instruction,design_window_check,color,size,ebay_user_id,selling_price,material_price,packaging_used,material_height,material_width,postage_cost,estimated_ebay,gross_profit,ebay_message_history) {
    var payload = new FormData();    
  ...
  updateorderById(id,svg_file,jpg_file,packaging_used,instructions,design_window_check,design_window_color,design_window_size,ebay_msg_history,ebay_user_id,estimated_ebay,gross_profit,material_height,material_price,material_width,postage_cost,selling_price,ticket_stage){
    ...
    payload.append('jpg_file', svg_file );
    payload.append('packaging_used', packaging_used);
